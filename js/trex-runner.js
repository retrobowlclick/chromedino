...
(function() {
  ...
  Runner.prototype = {
     ...
     * definition.
     */
    loadImages: function(nightMode) {
      var sprites1x = "offline-resources-1x";
      var sprites2x = "offline-resources-2x";
      if (nightMode) {
        sprites1x = "offline-resources-1x-night";
        sprites2x = "offline-resources-2x-night";
      }
      if (IS_HIDPI) {
        Runner.imageSprite = document.getElementById(sprites2x);
        this.spriteDef = Runner.spriteDefinition.HDPI;
      } else {
        Runner.imageSprite = document.getElementById(sprites1x);
    ...
    invert: function(reset) {
      if (reset) {
        ...
        document.body.classList.remove("inverted-trans");
        this.invertTimer = 0;
        this.inverted = false;
      } else {
        document.body.classList.add("inverted-trans");
...
var RunnerPlayer = new Runner(".interstitial-wrapper");

$(function() {
  $("#pause-game").on("click", function() {
    this.checked ? RunnerPlayer.stop() : RunnerPlayer.play();
  });
});
